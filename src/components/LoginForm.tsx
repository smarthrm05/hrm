  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white p-4 sm:p-6">
      ...
      <div className="w-full max-w-5xl mx-auto">
        {/* Card Besar dengan Background Ilustrasi */}
        <div
          className="relative w-full h-96 sm:h-[500px] md:h-[600px] rounded-2xl shadow-2xl overflow-hidden flex items-center justify-start"
          style={{
            backgroundImage: "url('/wave3.png')", // 👈 tinggal ganti path gambarnya
            backgroundSize: "cover",
            backgroundPosition: "center",
          }}
        >
          {/* Login Form Floating */}
          <div className="relative z-20 flex items-center justify-center w-full sm:w-1/2 p-4 sm:p-8">
