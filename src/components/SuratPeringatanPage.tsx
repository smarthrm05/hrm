...
import { Search, Plus, Eye, Trash2, Download, ChevronLeft, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold text-gray-900">Surat Peringatan</h1>
      </div>

      <Card>
        <CardHeader className="bg-blue-50 border-b">
          <CardTitle className="text-blue-800">Data Surat Peringatan</CardTitle>
        </CardHeader>
